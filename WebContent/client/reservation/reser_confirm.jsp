...
<div class="reser_content">
	...
	<form action="reserIAction.do" method="POST">
		...
		<div id="timepicker" style="display: none;">
			...
			<p style="margin-left: 29px;">
				예약시간 <select name="rTime" id="rTime">
					...
					<option value="09:30-10:00">(오전예약) 09:30-10:00</option>
					<option value="10:30-11:00">(오전예약) 10:30-11:00</option>
					<option value="11:30-12:00">(오전예약) 11:30-12:00</option>
					<option value="13:30-14:00">(오후예약) 13:30-14:00</option>
					<option value="14:30-15:00">(오후예약) 14:30-15:00</option>
					<option value="15:30-16:00">(오후예약) 15:30-16:00</option>
					<option value="16:30-17:00">(오후예약) 16:30-17:00</option>
					<option value="17:30-18:00">(오후예약) 17:30-18:00</option>
				</select>
			</p>
		</div>
